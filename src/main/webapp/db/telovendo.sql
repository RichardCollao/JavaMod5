...
--
-- Host: localhost
-- Generation Time: Apr 22, 2022 at 04:17 AM
...
INSERT INTO `producto` (`sku`, `nombre`, `categoria`, `fabricacion`, `stock`, `precio`) VALUES
(100001, ' Roma soy yo  ', 'Ciencia ficción', 'chile', 2, 18900),
(100002, ' El mir de Miguel. Crónicas de Memorias (Estuche 2 Vols)  ', 'Ciencia ficción', 'chile', 1, 40500),
(100003, ' (Preventa) la Patria en Sombras  ', 'Ciencia ficción', 'chile', 53, 15210),
(100004, ' (Preventa) Lascivia  ', 'Ciencia ficción', 'chile', 62, 15300),
(100005, ' Alto en salud  ', 'Ciencia ficción', 'chile', 5, 14400),
(100006, ' La lista de la suerte  ', 'Ciencia ficción', 'chile', 48, 12600),
(100007, ' La ciencia oscura  ', 'Ciencia ficción', 'chile', 79, 10800),
(100008, ' (Preventa) Astrología Lunar  ', 'Ciencia ficción', 'chile', 85, 13410),
(100009, ' Pruebas de apolo la maldicion del campa  ', 'Ciencia ficción', 'chile', 84, 10800),
(100010, ' Levantame los Pies  ', 'Ciencia ficción', 'chile', 75, 9730),
(100011, ' (Preventa) el Hechizo del Agua  ', 'Ciencia ficción', 'chile', 61, 17910),
(100012, ' (Preventa) Visión Cromática  ', 'Ciencia ficción', 'chile', 29, 15210),
(100013, ' (Preventa) El mentalista  ', 'Ciencia ficción', 'chile', 62, 8400),
(100014, ' Jujutsu Kaisen 14 ', 'Ciencia ficción', 'chile', 7, 13500),
(100015, ' Casa de cielo y aliento  ', 'Ciencia ficción', 'chile', 58, 11590),
(100016, ' Manifiesto Para los Héroes de Cada Día: Activa tu Positivismo Maximiza tu Productividad Sirve al Mundo (Divulgación)  ', 'Ciencia ficción', 'chile', 7, 13500),
(100017, ' El Rey De La Máscara Oscura  ', 'Ciencia ficción', 'chile', 17, 16560),
(100018, ' (Preventa) el Mapa de los Anhelos  ', 'Ciencia ficción', 'chile', 24, 8400),
(100019, ' Desobediente  ', 'Ciencia ficción', 'chile', 42, 6790),
(100020, ' Fleur. Mi Desesperada Decisión  ', 'Ciencia ficción', 'chile', 76, 16200),
(100021, ' Cuando no queden más estrellas que contar  ', 'Ciencia ficción', 'chile', 28, 10160),
(100022, ' Kame Un Océanos De Emociones  ', 'Ciencia ficción', 'chile', 10, 10500),
(100023, ' Reino Animal ', 'Ciencia ficción', 'chile', 47, 23800),
(100024, ' Ojos que no ven  ', 'Ciencia ficción', 'chile', 57, 15300),
(100025, ' Muerte en el Nilo ', 'Ciencia ficción', 'chile', 5, 4150),
(100026, ' Diez Miradas Sobre el Sistema de Gobierno  ', 'Ciencia ficción', 'chile', 42, 11700),
(100027, ' Loca pelvis  ', 'Ciencia ficción', 'chile', 55, 26970),
(100028, ' Cuerpos  ', 'Ciencia ficción', 'chile', 38, 10120),
(100029, ' Al Paraiso  ', 'Ciencia ficción', 'chile', 74, 13430);
